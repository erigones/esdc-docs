...
The first (main) compute node requires a local storage with at least **50 GB** of size and other compute nodes should have at least **20 GB** of local storage available.
